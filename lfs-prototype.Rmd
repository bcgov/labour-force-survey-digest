...
### Change in Number of Jobs in B.C.
...
feb_change_unemployment_bc_gender <- lfc_province_tidy %>%
  ...
  #    tab_header(
  #   title = "Change in B.C. Unemployment Rate by Age & Gender",
  ...
  text_transform(
  locations = cells_body(columns = "Males",
                         rows = Males > 0),
  fn = function(x)
    paste(x, up_arrow)
) %>%
...
text_transform(
  locations = cells_body(columns = "Females",
                         rows = Females > 0),
  fn = function(x)
    paste(x, up_arrow)
) %>%
...
gt(industry_unemployrt,
  ...
  # text_transform(
  #   locations = cells_body(
  #     columns = unique(industry_unemployrt_long$gender_age),
  #   ),
  #   fn = function(x) ifelse(x > 0, paste(x, up_arrow), paste(x, down_arrow))
  # )
  # data_color(
  ...
  # alpha = .6))
text_transform(
  locations = cells_body(columns = "Both sexes_15 to 24 years",
                         rows = `Both sexes_15 to 24 years` > 0),
  fn = function(x)
    paste(x, up_arrow)
) %>%
  text_transform(
  ...
  text_transform(
    locations = cells_body(columns = "Females_15 to 24 years",
                           rows = `Females_15 to 24 years` > 0),
    fn = function(x)
      paste(x, up_arrow)
  ) %>%
  text_transform(
  ...
  text_transform(
    locations = cells_body(columns = "Males_15 to 24 years",
                           rows = `Males_15 to 24 years` > 0),
    fn = function(x)
      paste(x, up_arrow)
  ) %>%
  text_transform(
  ...
  text_transform(
    locations = cells_body(columns = "Both sexes_25 to 54 years",
                           rows = `Both sexes_25 to 54 years` > 0),
    fn = function(x)
      paste(x, up_arrow)
  ) %>%
  text_transform(
  ...
  text_transform(
    locations = cells_body(columns = "Females_25 to 54 years",
                           rows = `Females_25 to 54 years` > 0),
    fn = function(x)
      paste(x, up_arrow)
  ) %>%
  text_transform(
  ...
  text_transform(
    locations = cells_body(columns = "Males_25 to 54 years",
                           rows = `Males_25 to 54 years` > 0),
    fn = function(x)
      paste(x, up_arrow)
  ) %>%
  text_transform(
  ...
  text_transform(
    locations = cells_body(columns = "Both sexes_55 years and over",
                           rows = `Both sexes_55 years and over` > 0),
    fn = function(x)
      paste(x, up_arrow)
  ) %>%
  text_transform(
  ...
  text_transform(
    locations = cells_body(columns = "Females_55 years and over",
                           rows = `Females_55 years and over` > 0),
    fn = function(x)
      paste(x, up_arrow)
  ) %>%
  text_transform(
  ...
  text_transform(
    locations = cells_body(columns = "Males_55 years and over",
                           rows = `Males_55 years and over` > 0),
    fn = function(x)
      paste(x, up_arrow)
  ) %>%
  text_transform(
...
gt(industry_employ,
  ...
  text_transform(
    locations = cells_body(
      columns = "Both sexes_15 to 24 years",
      rows = `Both sexes_15 to 24 years` > 0),
  ...
  text_transform(
    locations = cells_body(
      columns = "Females_15 to 24 years",
      rows = `Females_15 to 24 years` > 0),
    fn = function(x) paste(x, up_arrow)
  ) %>%
    text_transform(
  ...
  text_transform(
    locations = cells_body(
      columns = "Both sexes_25 to 54 years",
      rows = `Both sexes_25 to 54 years` > 0),
    fn = function(x) paste(x, up_arrow)
  ) %>%
    text_transform(
  ...
  text_transform(
    locations = cells_body(
      columns = "Females_25 to 54 years",
      rows = `Females_25 to 54 years` > 0),
    fn = function(x) paste(x, up_arrow)
  ) %>%
    text_transform(
  ...
  text_transform(
    locations = cells_body(
      columns = "Both sexes_55 years and over",
      rows = `Both sexes_55 years and over` > 0),
    fn = function(x) paste(x, up_arrow)
  ) %>%
    text_transform(
  ...
  text_transform(
    locations = cells_body(
      columns = "Females_55 years and over",
      rows = `Females_55 years and over` > 0),
    fn = function(x) paste(x, up_arrow)
  ) %>%
    text_transform(
  ...
  text_transform(
    locations = cells_body(
      columns = "Males_55 years and over",
      rows = `Males_55 years and over` > 0),
    fn = function(x) paste(x, up_arrow)
  ) %>%
    text_transform(
