...
valueBox(
  ...
  filter(vector == "v2064732",
    ...
    signs(format = percent, accuracy = 0.1)),
  # icon = "fa-users-cog",
  caption = paste("B.C. Unemployment Rate for Youth (Aged 15 to 24 Years) for", report_month, report_year)
)
```
...
### Youth Month-Over-Month Change in Number of Jobs in B.C. (Ages 15 to 24 Years) by Gender in `r report_year` 
