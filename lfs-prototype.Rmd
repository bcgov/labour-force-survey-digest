...
valueBox(
  value = paste0("Women: ",
    ...
    signs(format = comma)),
  # icon = "fa-users-cog",
  caption = paste("Number of Jobs for Women in B.C. for", report_month, report_year, "(Ages 25 Years & Over)")
)
```
...
valueBox(
  value = paste0("Men: ",
    ...
    signs(format = comma)),
  # icon = "fa-users-cog",
  caption = paste("Number of Jobs for Men in B.C. for", report_month, report_year, "(Ages 25 Years & Over)")
)
```
