...
valueBox(
  value = paste0("Women: ",
    ...
    signs(format = comma,
          add_plusses = TRUE)),
  # icon = "fa-users-cog",
  caption = paste("Month-Over-Month Change in Jobs for Women in B.C. for", report_month, report_year, "(Ages 25 Years & Over)")
)
```
...
valueBox(
  value = paste0("Men: ",
    ...
    signs(format = comma,
          add_plusses = TRUE)),
  # icon = "fa-users-cog",
  caption = paste("Month-Over-Month Change in Jobs for Men in B.C. for", report_month, report_year, "(Ages 25 Years & Over)")
)
```
...
valueBox(
  ...
  filter(
    ...
    signs(format = comma,
          add_plusses = TRUE)),
  # icon = "fa-users-cog",
  caption = paste("Month-Over-Month Change in Number of Full-time Jobs in B.C. for", report_month, report_year)
)
```
...
valueBox(
  ...
  filter(
    ...
    signs(format = comma,
          add_plusses = TRUE)),
  # icon = "fa-users-cog",
  caption = paste("Month-Over-Month Change in Number of Part-time Jobs in B.C. for", report_month, report_year)
)
```
